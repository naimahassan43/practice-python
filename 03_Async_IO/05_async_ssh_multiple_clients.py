...
async def run_multiple_clients(hosts):
    ...
    for result in results:
        ...
        print('#' * 50)
hosts = [
    {'host': '192.168.92.130','username': 'naima', 'password': '674343', 'command': 'who -a'},
    {'host': '192.168.92.130','username': 'admin', 'password': 'pass123', 'command': 'ifconfig'},
    {'host': '192.168.92.130','username': 'admin', 'password': 'pass123', 'command': 'uname -a'},
]
